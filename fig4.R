...
logSites <- import.bed("C:/Users/sheal/Desktop/AnoleAge/Fig1.1-DSSLogAge/data/LogAgeSites_smoothed200.bed")
...
ggsave(a, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/LogAgeSites_RidgeRegression_Test.png",
       width = 5, height = 4)
...
ggsave(roiCorPlot, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/HubRegion_corPlot.png",
       width = 7, height = 4)
...
ggsave(avgs.roi.trend, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/HubRegion_avgPlot.png",
       width = 5, height = 4)
...
ggsave(roi.clock, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/hubRegion_AVGclock.png",
       width = 5, height = 4)
...
blueMod <- read.table("C:/Users/sheal/Desktop/AnoleAge/WGCNA/data/blue.mat", sep = "\t")
...
ggsave(blue.clock, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/BlueMod_PCclock_PredictVsActual.png",
       width = 5, height = 4)
...
#write.table(age.coeffs.df, file = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/data/ElasticNet_sites.tab",
#           sep = "\t", col.names = TRUE)
...
ggsave(plot.CpG.test, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/ElasticNet_Test.png",
       width = 5, height = 4)
...
#write.csv(actual.predicted, 
 #         file = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/data/ElasticNet_TestSet_Predictions.csv",
 #         row.names = FALSE)
...
allErrors.long <- tidyr::pivot_longer(allErrors, cols = c(5:8), names_to = "Clock", values_to = "Errors")
...
ggsave(s, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/Errors_by_ageClass.png",
       width = 6, height = 5)

#### Quantify error differences across age via means and t-tests

mean(allErrors.long$Errors[which(allErrors.long$bins == "1-18 Mnth")])
mean(allErrors.long$Errors[which(allErrors.long$bins == "36-60 Mnth")])

t.test(allErrors.long$Errors[which(allErrors.long$bins == "1-18 Mnth")], 
       allErrors.long$Errors[which(allErrors.long$bins == "36-60 Mnth")])

mean(abs(allErrors.long$Errors[which(allErrors.long$bins == "1-18 Mnth")]))
mean(abs(allErrors.long$Errors[which(allErrors.long$bins == "36-60 Mnth")]))

t.test(abs(allErrors.long$Errors[which(allErrors.long$bins == "1-18 Mnth")]), 
       abs(allErrors.long$Errors[which(allErrors.long$bins == "36-60 Mnth")]))
...
ggsave(s2, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/Errors_by_sex.png",
       width = 6, height = 5)
...
for (i in 1:nrow(dataset)){
    ...
    set.seed(1998) #setting seed
    #using 6 fold cross validation to estimate the lambda parameter 
    age.cv <- cv.glmnet(as.matrix(train.CpG), 
                        as.matrix(train.age),
                        alpha=0.5, nfolds=10, family="gaussian")
    #define the lambda parameter
    best_lambda <- age.cv$lambda.min
    BestLambdas<-append(BestLambdas,best_lambda) ##write lambda values for each iteration to list
    ##run elastic net
...
write.table(merged_info, file = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/data/loocv_results.tsv",
            sep = "\t", quote = FALSE, col.names = TRUE)

merged_info <- read.table("C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/data/loocv_results.tsv",
            sep = "\t", header = TRUE)
...
write.table(commonSites,"C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/data/n_occur30_LOOCVsites.tab", quote = FALSE,
...
ggsave(LOOCV.test, filename = "C:/Users/sheal/Desktop/AnoleAge/Fig4-Clocks/images/LOOCV_actualVSpred.png",
       width = 5, height = 4)
